...
export enum ErrorCodes {
  ...
  CREDIT_APPROVAL_INVALID = 'CREDIT_APPROVAL_INVALID',
  CREDIT_APPROVAL_SELF_DENIED = 'CREDIT_APPROVAL_SELF_DENIED',
  ...
  // Delivery / shipment queue (POS)
  DELIVERY_NOT_FOUND = 'DELIVERY_NOT_FOUND',
  DELIVERY_ADDRESS_REQUIRED = 'DELIVERY_ADDRESS_REQUIRED',
  DELIVERY_CUSTOMER_REQUIRED = 'DELIVERY_CUSTOMER_REQUIRED',
  DELIVERY_TRANSACTION_NOT_FOUND = 'DELIVERY_TRANSACTION_NOT_FOUND',
  DELIVERY_ALREADY_EXISTS = 'DELIVERY_ALREADY_EXISTS',
  DELIVERY_STATUS_TRANSITION_INVALID = 'DELIVERY_STATUS_TRANSITION_INVALID',
  DELIVERY_CANCEL_REASON_REQUIRED = 'DELIVERY_CANCEL_REASON_REQUIRED',
