...
| Manajemen Pengiriman Toko | [domain/DELIVERY-MANAGEMENT.md](./domain/DELIVERY-MANAGEMENT.md) | Pengiriman toko langsung (POS) & order online: antrian DLV, status workflow, integrasi CRM alamat | Rina, Fajar, Dimas, Citra | 2026-06-09 | `#domain` `#delivery` `#pos` `#fase2` |
